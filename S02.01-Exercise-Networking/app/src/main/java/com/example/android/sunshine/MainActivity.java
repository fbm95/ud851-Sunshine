...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadWeatherData(){
        ...
        new NetworkBackgroundTask().execute(location);
    }
    ...
    private class NetworkBackgroundTask extends AsyncTask<String, Void, String[]>{
        ...
        protected String[] doInBackground(String... params) {
            ...
            try{
                String weatherJson = NetworkUtils.getResponseFromHttpUrl(weatherUrl);
                String[] simpleWeatherData = OpenWeatherJsonUtils.getSimpleWeatherStringsFromJson(MainActivity.this, weatherJson);
        ...
        protected void onPostExecute(String[] s) {
            if( s!= null ){
                for(String string: s){
                    mWeatherTextView.append(string.toString() + "\n\n");
                }
            }
        }
    }
